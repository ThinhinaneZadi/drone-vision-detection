...
out_video = "results/videos/task3/task3_single_object_candidate28_pedestrian.mp4"
out_csv = "results/metrics/task3_single_object_candidate28_trajectory.csv"
...
# -----------------------------
# Read selected candidate from CSV
# -----------------------------
target_box = None
target_class = None
...
for frame_idx, result in enumerate(results_stream, start=1):
    ...
    if boxes is not None and boxes.id is not None:
        ...
        # Match candidate 28 in the first frame to a ByteTrack ID
        if frame_idx == 1:
            best_iou = 0
            best_track_id = None
            ...
            for box, track_id, cls_id in zip(xyxy, ids, cls):
                ...
                # Prefer matching the same class
    ...
    cv2.putText(frame, f"Task 3 Single-Object Tracking | Candidate {candidate_id}",
...
print("\nSaved Task 3 video:", out_video)
print("Saved Task 3 trajectory CSV:", out_csv)
